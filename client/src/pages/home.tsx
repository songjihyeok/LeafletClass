                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 mb-4 leading-relaxed">
                      프론트엔드, 백엔드, 데이터베이스의 역할과 상호작용.
                      전체적인 웹 서비스 아키텍처를 이해하고 리플릿에서 어떻게
                      구현되는지 배웁니다.
                    </p>
              ...
              <CardContent className="p-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 mb-4 leading-relaxed">
                      리플릿 계정 설정부터 무료 티어 최대 활용법까지. 개발
                      비용을 최소화하면서 최적의 개발 환경을 구축하는 노하우를
                      전수합니다.
                    </p>
                    <div className="flex items-center text-replit-orange font-medium">
                      <Clock className="w-4 h-4 mr-2" />
              ...
              <CardContent className="p-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 mb-4 leading-relaxed">
                      정적 파일 호스팅부터 이미지 최적화까지. 리플릿에서 미디어
                      파일을 효율적으로 관리하고 배포하는 전문적인 방법을
                      익힙니다.
                    </p>
                    <div className="flex items-center text-replit-orange font-medium">
                      <Clock className="w-4 h-4 mr-2" />
              ...
              <CardContent className="p-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 mb-4 leading-relaxed">
                      사용자 인증 시스템 구축과 보안 설정. OAuth부터 세션
                      관리까지, 안전하고 사용자 친화적인 로그인 시스템을
                      완성합니다.
                    </p>
                    <div className="flex items-center text-replit-orange font-medium">
                      <Clock className="w-4 h-4 mr-2" />
              ...
              <CardContent className="p-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 mb-4 leading-relaxed">
                      커스텀 도메인 설정과 DNS 관리. 리플릿 프로젝트에 개인
                      도메인을 연결하여 전문적인 웹사이트를 완성하는 방법을
                      배웁니다.
                    </p>
                    <div className="flex items-center text-replit-orange font-medium">
                      <Clock className="w-4 h-4 mr-2" />
