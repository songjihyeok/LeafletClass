...
const curriculumItems = [
  {
    ...
    title: "웹 서비스 구조 이해하기",
    description:
      "프론트엔드, 백엔드, 데이터베이스의 역할과 상호작용. 전체적인 웹 서비스 아키텍처를 이해하고 레플릿에서 어떻게 구현되는지 배웁니다.",
    duration: "20분",
  },
  {
    icon: Settings,
    title: "비용 절감을 위한 레플릿 초기 세팅",
    description:
      "레플릿 계정 가입부터 프럼프트 노하우 공유까지, 개발 비용을 최소화하면서 리플렛으로 개발하는 노하우를 전수합니다.",
    duration: "40분",
  },
  {
    icon: Image,
  ...
  },
  {
    ...
    title: "깃 관리하기",
    description:
      "레플릿 환경에서의 Git 활용법. 버전 관리부터 협업까지, 레플릿과 깃허브를 연동한 효율적인 개발 워크플로우를 배웁니다.",
    duration: "30분",
  },
  {
    icon: Globe,
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            6개의 핵심 모듈로 구성된 체계적인 커리큘럼으로 레플릿을 시작하세요
          </p>
        </div>
